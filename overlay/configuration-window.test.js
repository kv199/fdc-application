...
test('Events keeps the existing navigation and exposes the create/detail flow', () => {
  ...
  assert.match(settingsCss, /\.events-discard-dialog__no\s*\{[\s\S]*background:\s*#69e83f/)
  assert.match(settingsCss, /\.events-discard-dialog__yes:hover\s*\{[\s\S]*background:\s*#ef4444/)
